...
function removeLoadingButton(){  
  sendButton.className = sendButton.className.replace(new RegExp('(?:^|\\s)loading(?!\\S)'), '');
}

$("#contactform").on("submit", function(e) {
  sendButton.className = sendButton.className + ' loading';
  ...
  if (message === "") {
    ...
    $.ajax({
      url:"https://script.google.com/macros/s/AKfycbzz9KiQOqgcZ0P1ziNl1vxsdu3iLiQfBASuV87gt3I12fm0cmlnGsXX0JqQv8vJl9uhBA/exec",
      data:$(this).serialize(),
      type:"POST",
